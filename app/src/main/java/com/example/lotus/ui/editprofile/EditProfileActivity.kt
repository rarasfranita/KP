...
class EditProfileActivity : AppCompatActivity() {
                ...
                object : ParsedRequestListener<Respon> {
                    override fun onResponse(respon: Respon) {
                        ...
                        if (respon.code.toString() == "200") {
                            ...
                            Toast.makeText(this@EditProfileActivity, "Error while getting data profile, code: ${respon.code} \n${respon.data}", Toast.LENGTH_SHORT).show()
                            Log.e("ERROR!!!", "Like Post ${respon.code}, ${respon.data}")
                        }
                    }

                    override fun onError(anError: ANError) {
                        Toast.makeText(this@EditProfileActivity, "Error while getting data profile, code: ${anError.errorDetail}", Toast.LENGTH_SHORT).show()
    ...
    private fun setProfile(data: User) {
        ...
        EditProfileUsername.text = data.name.toEditable()
