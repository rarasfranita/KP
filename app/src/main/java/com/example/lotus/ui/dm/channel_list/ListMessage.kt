package com.example.lotus.ui.dm.channel_list
...
import com.example.lotus.databinding.ListMessageBinding
import com.example.lotus.ui.dm.home.HomeFragmentDMDirections
...
class ListMessage : Fragment() {
    override fun onCreateView(
        ...
        val binding = ListMessageBinding.inflate(inflater, container, false)
        ...
        binding.channelList.setOnChannelClickListener { channel ->
            findNavController().navigate(
                HomeFragmentDMDirections.navHomeToChannel(channel.type, channel.id)
            )
        }
        return binding.root
    }
